...
public class RoomBlueprint : MonoBehaviour
{
    ...
    public GameObject GetWallVoxelGO(Vector3 worlPosition)
    {
        return wallsVoxelGoMap[worlPosition];
    }

    public GameObject GetDoorVoxelGO(Vector3 worlPosition)
    {
        return doorsVoxelGoMap[worlPosition];
    }
