...
public class DungeonSet : ScriptableObject
{
    ...
    protected List<Element> GetTemplateElements(List<Element> templates)
    {
    ...
    protected void InitTemplatePool(List<Element> templates, Dictionary<string, List<GameObject>> pools)
    {
        int templatesCount = templates.Count;
        for (int i = 0; i < templatesCount; i++)
        {
